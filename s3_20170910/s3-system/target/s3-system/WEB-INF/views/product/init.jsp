...
<div class="operate">
	<div class="om-panel-header">产品清单</div>
	<div class="icon">
		<ul>
	   		<li><a href="#" onclick="showDetailAdd();"><span class="menu1"></span>新增</a></li>
	   		<li><a href="#" onclick="showEdit('/product/showEdit','id',700,280);"><span class="menu13"></span>编辑</a></li>
...
$(function() {
    $('#grid').datagrid({
        ...
        columns : [
            [
                ...
                {width : '100',title : '产品类型',field : 'typeId',formatter:function(val,row,index){
                    return row.productType.productType;
                }},
                {width : '12%',title : '产品名称',field : 'productName'},
                {width : '12%',title : '批发价格',field : 'price'},
				{width : '12%',title : '说明',field : 'note'},
    ...
    $('#productType').combobox({
        ...
        onSelect:function(record){
            ...
            $.post(ctx+"/holeSale/getProduct.action", {"id": value},
                function (row) {
                    var temp = []
...
function showDetailAdd(){
	$.dialog.open(ctx+'/product/showAdd', {
		lock: true,
		width:850,
		height:380
	});
