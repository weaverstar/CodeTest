...
<body>
<form id="form1" action="/resale/add.action">
	...
	<div class="dialogPage">
		...
		<div class="editDiv">
			<table class="editTable">
				...
				<tr>
					<td><span class="required">*</span>零售单价：</td>
					<td ><input type="text" id="price" name="price"  class="easyui-numberbox" ></td>
					<td><span class="required">*</span>零售数量：</td>
					<td >
						<input type="text" id="productNum" name="productNum"  class="easyui-numberbox">
					</td>
				</tr>
				<tr>
