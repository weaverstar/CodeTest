        ...
        <div class="editDiv">
            <table class="editTable">
                ...
                <tr>
                    ...
                    <td ><input type="text" id="temp1" name="temp1" type="combo" value="${entrepot.temp1}"></td>--%>
                    <td><span class="required">*</span>数量：</td>
                    <td ><input type="text" id="total" name="total" type="combo" value="${entrepot.total}"></td>
                </tr>
