...
<div class="operate">
	<div class="om-panel-header">角色管理权限</div>
	<div class="icon">
		<ul>
    		<li><a href="#" onclick="showAdd('/system/prg/role/showAdd',700,240);"><span class="menu1"></span>新增</a></li>
...
$(function() {      
	$('#grid').datagrid({   
	    ...
	    columns : [[ {width : '150', field : 'ck',checkbox:true},
					 ...
					 {width : '150',title : '更新时间',field : 'updateTime'}]
	    		]
	}); 
});
function bindMenu(){
