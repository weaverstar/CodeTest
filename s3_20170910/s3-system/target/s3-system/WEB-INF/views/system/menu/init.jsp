...
<style>
	.datagrid-btable,.datagrid-header-inner,.datagrid-htable{width:100%;}
</style>
</head>
<body>
<div id="toolbar" >	
	...
	<div class="operate">
		...
		<div class="icon" style="right:200px;">
			<ul>
	    		<li><a href="#" onclick="showMenuAdd();"><span class="menu1"></span>新增</a></li>
	    		<li><a href="#" onclick="showEdit('/system/prg/menu/showEdit','menuId',680,260);"><span class="menu13"></span>修改</a></li>
	    		<li><a href="#" onclick="removeRow('menuId');"><span class="menu11"></span>删除</a></li>
			</ul>
		</div>
	</div>
</div>
<table id="grid" data-options="fit:false,border:false" style="width:83%;height:100%;"></table>
...
$(function() {	
     ...
     $('#grid').datagrid({   
 	    ...
 	    columns : [[ {width : '50', field : 'ck',checkbox:true},
 	                 {width : '100',title : '菜单名称',field : 'menuName'},
 	                 {width : '200',title : '菜单路径',field : 'menuUrl'},
 	                 {width : '100',title : '菜单级别',field : 'menuLevel'},
...
function loadTree(){
	 $('.panel.datagrid.easyui-fluid').css({position:'absolute',left:'17%'});  
	 $('body').append('<div class="treeDiv" style="display:block;overflow-y: auto;width:17%;"><ul id="navtree"></ul></div>');
	...
	$.post("getMenu", {"menuId":menuPid},
	   function(msg){		
			if(msg.menuLevel>=3 && msg.menuType==1 ){
				...
				showAdd('/system/prg/menu/showAdd?menuPid='+menuPid,680,260);
			}
      }, "json");
}
</script>
