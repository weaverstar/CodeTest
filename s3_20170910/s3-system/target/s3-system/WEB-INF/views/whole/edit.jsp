			...
			<div class="editDiv">
				<table class="editTable">
					<tr>
						...
						<td ><input type="text" id="customerId" name="customerId" type="combo" value="${wholeSaleMainModel.customerId}"></td>
						<td><span class="required">*</span>电话：</td>
						<td ><input type="text" id="phone" name="phone"  type="combo"  value="${wholeSaleMainModel.phone}"></td>
					</tr>
					<tr>
						<td><span class="required">*</span>地市：</td>
						<td ><input type="text" id="city" name="city" type="combo" value="${wholeSaleMainModel.city}"></td>
						<td><span class="required">*</span>乡镇：</td>
						<td ><input type="text" id="town" name="town"  type="combo" value="${wholeSaleMainModel.town}"></td>
					</tr>
					<tr>
						<td><span class="required">*</span>是否付款：</td>
						<td ><input type="text" id="temp2" name="temp2" type="combo" value=""></td>
					</tr>
					<tr>
						<td><span class="required">*</span>说明：</td>
						<td colspan="3"><textarea id="note" name="note"  type="note" style="width:100%;height:80px;">${wholeSaleMainModel.note}</textarea></td>
					</tr>
				</table>
				<table style="width:90%" id="detail">
					...
					<c:forEach items="${wholeSaleList}" var="wholeSaleModel" varStatus="index">
						<tr id="edit_num">
							<td>
								<input type="checkbox" id="num_${index.index}_0">
							</td>
							<td>
								<input type="hidden" id="productTypeId_${index.index}_1" name="productTypeId_${index.index}_1" value="${wholeSaleModel.product_type}">
								<input type="text" id="productType_${index.index}_1" name="productType_${index.index}_1" value="${wholeSaleModel.productType}">
							</td>
							<td>
								<input type="text" id="product_${index.index}_2" name="product_${index.index}_2" value="${wholeSaleModel.product}">
							</td>
							<td>
								<input type="text" id="price_${index.index}_3" name="price_${index.index}_3" value="${wholeSaleModel.price}">
							</td>
							<td>
								<input type="text" id="productNum_${index.index}_4" name="productNum_${index.index}_4" value="${wholeSaleModel.productNum}">
							</td>
							<td>
								<input type="text" id="unit_${index.index}_5" name="unit_${index.index}_5" value="${wholeSaleModel.unit}">
							</td>
						</tr>
					</c:forEach>
...
<script type="text/javascript">
    ...
    function comboxComponent(typeid,id,data,value,td){
        var temp;
        if(data == ""){
            temp = [];
        }else{
