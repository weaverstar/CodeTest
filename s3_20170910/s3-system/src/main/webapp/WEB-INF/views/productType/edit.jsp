			...
			<div class="editDiv">
				<table class="editTable">
					<tr>
						...
						<td ><input type="text" id="productType" name="productType" type="combo" value="${productType.productType}"></td>
					...
					<tr>
						<td>说明：</td>
						<td colspan="3"><textarea id="note" name="note"  type="note" style="width:100%;height:80px;">${productType.note}</textarea></td>
					</tr>
