		...
		<table class="editDiv">
			<table class="editTable" style="margin: 2px;">
				<tr>
					...
					<td><input type="text" id="frequencyName" name="frequencyName" value="${hourScaleModel.frequencyName}"></td>
					<td><span class="required"></span>RemainingPercentage：</td>
					<td><span id="last">0</span></td>
				</tr>
			</table>
			<div style="overflow: hidden;width:1055px;">
				...
				<table class="editTable" style="margin: 2px;">
					...
					<tr>
						...
						<td><input type="text" index="1" id="hour1" name="hour1" value="${hourScaleModel.hour1}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>01:00-02:00:</td>
						<td><input type="text"  index="2"  id="hour2" name="hour2" value="${hourScaleModel.hour2}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>02:00-03:00:</td>
						<td><input type="text" index="3" id="hour3" name="hour3" value="${hourScaleModel.hour3}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>03:00-04:00:</td>
						<td><input type="text" index="4"  id="hour4" name="hour4" value="${hourScaleModel.hour4}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>04:00-05:00:</td>
						<td><input type="text" index="5"  id="hour5" name="hour5" value="${hourScaleModel.hour5}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>05:00-06:00:</td>
						<td><input type="text" index="6" id="hour6" name="hour6" value="${hourScaleModel.hour6}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>06:00-07:00:</td>
						<td><input type="text" index="7"  id="hour7" name="hour7" value="${hourScaleModel.hour7}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>07:00-08:00:</td>
						<td><input type="text" index="8"  id="hour8" name="hour8" value="${hourScaleModel.hour8}"  class="easyui-numberbox" ></td>
					</tr>
				</table>
			</div>
			...
			<div style="float:left" class="editDiv">
				<table class="editTable" style="margin: 2px;">
					...
					<tr>
						...
						<td><input type="text"  index="9" id="hour9" name="hour9" value="${hourScaleModel.hour9}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>09:00-10:00:</td>
						<td><input type="text" index="10"  id="hour10" name="hour10" value="${hourScaleModel.hour10}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>10:00-11:00:</td>
						<td><input type="text" index="11"  id="hour11" name="hour11" value="${hourScaleModel.hour11}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>11:00-12:00:</td>
						<td><input type="text" index="12" id="hour12" name="hour12" value="${hourScaleModel.hour12}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>12:00-13:00:</td>
						<td><input type="text" index="13"  id="hour13" name="hour13" value="${hourScaleModel.hour13}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>13:00-14:00:</td>
						<td><input type="text"  index="14" id="hour14" name="hour14" value="${hourScaleModel.hour14}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>14:00-15:00:</td>
						<td><input type="text"  index="15" id="hour15" name="hour15" value="${hourScaleModel.hour15}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>15:00-16:00:</td>
						<td><input type="text" index="16"  id="hour16" name="hour16" value="${hourScaleModel.hour16}"  class="easyui-numberbox" ></td>
					</tr>
				</table>
			</div>
			...
			<div style="float:left" class="editDiv">
				<table class="editTable" style="margin: 2px;">
					...
					<tr>
						...
						<td><input type="text"  index="17" id="hour17" name="hour17" value="${hourScaleModel.hour17}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>17:00-18:00:</td>
						<td><input type="text" index="18"  id="hour18" name="hour18" value="${hourScaleModel.hour18}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>18:00-19:00:</td>
						<td><input type="text" index="19"  id="hour19" name="hour19" value="${hourScaleModel.hour19}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>19:00-20:00:</td>
						<td><input type="text" index="20"  id="hour20" name="hour20" value="${hourScaleModel.hour20}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>20:00-21:00:</td>
						<td><input type="text"  index="21" id="hour21" name="hour21" value="${hourScaleModel.hour21}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>21:00-22:00:</td>
						<td><input type="text" index="22"  id="hour22" name="hour22" value="${hourScaleModel.hour22}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>22:00-23:00:</td>
						<td><input type="text"  index="23" id="hour23" name="hour23" value="${hourScaleModel.hour23}"  class="easyui-numberbox" ></td>
					</tr>
					<tr>
						<td><span class="required">*</span>23:00-00:00:</td>
						<td><input type="text"  index="24" id="hour24" name="hour24" value="${hourScaleModel.hour24}"  class="easyui-numberbox" ></td>
					</tr>
				</table>
			</div>
			</div>
