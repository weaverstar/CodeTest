...
<div id="search" class="easyui-panel" title="查询条件" data-options="fit:true,collapsible:true,border:0">
  ...
  <table class="searchTable">
	  <tr>
		  ...
		  <td>姓名:</td>
		  <td><input type="text" id="customerName" name="customerName"  type="combo"/></td>
	  </tr>
	  <tr>
		  <td>城市:</td>
...
<div class="operate">
	<div class="om-panel-header">客户清单</div>
	<div class="icon">
		<ul>
	   		<li><a href="#" onclick="showDetailAdd();"><span class="menu1"></span>新增</a></li>
	   		<li><a href="#" onclick="showEdit('/customer/showEdit','id',700,280);"><span class="menu13"></span>编辑</a></li>
    ...
    $('#grid').datagrid({
        ...
        columns : [
            [
                ...
                {width : '12%',title : '姓名',field : 'customerName'},
                {width : '12%',title : '性别',field : 'sex',formatter:function(value,row,index){
                    return JSON.parse('${sexMap}')[value]}
                },
				{width : '12%',title : '城市',field : 'cityId'},
				{width : '12%',title : '乡镇',field : 'townId'},
				{width : '12%',title : '电话',field : 'phone'},
                {width : '18%',title : '是否有效',field : 'statusId',formatter:function(value,row,index){
...
function showDetailAdd(){
	$.dialog.open(ctx+'/customer/showAdd', {
		lock: true,
		width:850,
		height:380
	});
