...
<table width="98%" class="haveBorder" style="border:0">
    ...
    <tr>
       <td align="left" colspan="2">流水号:${wholeSaleMain.temp3}</td>
...
<c:forEach items="${wholeSaleList}" var="wholeSaleModel" varStatus="index">
    <tr>
        <td>${wholeSaleModel.productType}-${wholeSaleModel.product}</td>
        <td>${wholeSaleModel.productNum}</td>
        <td>${wholeSaleModel.unit}</td>
        <td>${wholeSaleModel.price}</td>
        <td>${wholeSaleModel.price * wholeSaleModel.productNum}</td>
    </tr>
</c:forEach>
