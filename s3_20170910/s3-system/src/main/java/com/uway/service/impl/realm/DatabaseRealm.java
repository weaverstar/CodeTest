package com.uway.service.impl.realm;
...
import com.uway.system.service.SysRoleService;
 ...
 * @see /home=user 表示用户不一定需要已经通过认证,只需/admins/user/要曾经被Shiro记住过登录状态就可以正常发起'/home'请求
 * @see 
 *      ==========================================================================
 *      ===================================================
