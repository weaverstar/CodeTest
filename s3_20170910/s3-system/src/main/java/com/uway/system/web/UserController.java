...
public class UserController extends BaseController {
	...
	public String init(HttpServletRequest request){
		...
		request.setAttribute("initPassword", SysInitConfig.getInstance().get(CfgProp.jsb_DEFAULTPASSWORD));
	...
	public String update(HttpServletRequest request,SysUser user){
		...
		sysUser.setRelateUserId(user.getRelateUserId());//关联的用户ID
	...
	public void initPwd(HttpServletRequest request,PrintWriter out){
		...
		try {
			...
			for(String id:aId){
				...
				sUser.setUserPwd(SysInitConfig.getInstance().get(CfgProp.jsb_DEFAULTPASSWORD));
