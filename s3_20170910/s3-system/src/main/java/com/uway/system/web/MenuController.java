...
import com.uway.core.util.Globals;
...
public class MenuController extends BaseController {
	...
	public String insert(HttpServletRequest request,SysMenu menu){
		...
		Integer menuLevel = menu.getMenuLevel()+1;
	...
	public void tree(HttpServletRequest request, HttpServletResponse response){
		String resourceTree = sysMenuService.listTree(false,false);
	...
	public void checkMenuName(HttpServletRequest request,HttpServletResponse response,SysMenu menu) {
		...
		condititon.put("menuPid", menu.getMenuPid());
