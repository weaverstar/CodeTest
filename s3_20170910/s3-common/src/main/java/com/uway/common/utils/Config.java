...
public class Config {
	...
	/*	Config config = new Config(
				...
				null);*/
		Config  config = new Config(new ClassPathResource("/message/hotCarBrandList.xml").getInputStream(),"");
		
		if(config != null && config.getRootNode() != null){
			System.out.println(config.get("/xml/FromUserName"));
		}
